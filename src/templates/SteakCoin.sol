...
contract SteakCoin {
    ...
    uint256 public constant TRANSFER_BURN_BPS = 100;
    uint256 public constant TRANSFER_SIZZLE_BPS = 50;
    uint256 public sizzlePool;

    uint256 public constant MAX_TX_BPS = 100;
    ...
    uint256[NUM_TIERS] public tierMultiplier;
